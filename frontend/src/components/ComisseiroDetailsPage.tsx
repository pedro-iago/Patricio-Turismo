...
const ComisseiroDetailsPage = () => {
  ...
  // ... (useEffect de fetch - ADAPTADO PARA COMISSEIRO) ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        const [passageirosData, encomendasData] = await Promise.all([
          getComisseiroPassageirosReport(id, inicio, fim), // ✅ MUDANÇA
          getComisseiroEncomendasReport(id, inicio, fim),  // ✅ MUDANÇA
        ]);
  ...
  return (
    <div className="space-y-6">
      {/* ... (Cabeçalho e DatePicker - TÍTULO ALTERADO) ... */}
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div className="flex items-center gap-4">
           <Button variant="ghost" size="icon" onClick={() => navigate('/affiliates')}>
            ...
            <div>
              <h2 className="text-2xl font-semibold">Relatório do Comissário</h2> {/* ✅ MUDANÇA */}
